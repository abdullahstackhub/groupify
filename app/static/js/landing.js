...
groups.forEach((group, index) => {
    ...
    let groupData = `
    <div class="col-md-3 my-3">
        <div class="item group-card hidden-card">
            <div class="groups">
                <div class="row">
                    <div class='col-md-6 col-sm-6 w-50'>
                        <p class="group_card_category">${group.category}</p>
...
gsap.utils.toArray('.group-card').forEach((card, i) => {
    gsap.fromTo(card, 
        ...
        { 
            ...
            scrollTrigger: {
                trigger: card,
                start: "top 85%", // Start animation when 80% in viewport
                toggleActions: "play none none reverse" // Fade in when scrolling down, fade out when scrolling up
            }
        }
    );
});
